...
* **Installation:** * Pre-built executables are available in the [Releases](/releases/latest) page (compiled with PyInstaller on Python 3.10 / Windows 11).
...
* **Installation:** * Pre-built executables are available in the [Releases](/releases/latest) page.
